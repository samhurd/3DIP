...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        mathbtn = tk.Button(self, text = "Maths", command= lambda *args: [controller.up_frame("QuizPage"), subject_select(0), print(variable)])
        mathbtn.pack()

        engbtn = tk.Button(self, text = "English", command= lambda *args: [controller.up_frame("QuizPage"), subject_select(1), print(variable)])
        engbtn.pack()

        phybtn = tk.Button(self, text = "Physics", command= lambda *args: [controller.up_frame("QuizPage"), subject_select(2), print(variable)])
        phybtn.pack()

        sosbtn = tk.Button(self, text = "Social Studies", command= lambda *args: [controller.up_frame("QuizPage"), subject_select(3), print(variable)])
        sosbtn.pack()        
