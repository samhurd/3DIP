...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        engbtn = tk.Button(self, text = "English", command= lambda *args: [controller.up_frame("QuizPage"), subject_select(2), print(subject)])
        engbtn.pack()

        phybtn = tk.Button(self, text = "Physics", command= lambda *args: [controller.up_frame("QuizPage"), subject_select(3), print(subject)])
        phybtn.pack()
...
class WelcomeScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text = "\n Welcome to the BDSC Revision Quiz! \n", font = controller.titlefont)
        label.pack()

        self.after(3000, lambda: controller.up_frame("LoginPage"))  
...
if subject == 2:
    question = (data['phyquestions'])
    options = (data['phyoptions'])
    answer = (data['phyanswers'])
